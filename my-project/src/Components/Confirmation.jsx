...
const Confirmation = ()=>{
    ...
    return(
        <>
        <section className="md:w-[40%] md:mx-auto w-screen h-[100%] mt-4 ">
            ...
            
        {
          ...
          <div className='md:w-[50%] md:mx-auto flex justify-center items-center' >
          <Link to='/'> <button className='bg-[#000000] h-[3.5rem] md:w-[40vw] w-[80vw] rounded-lg text-white p-3 text-xl mt-5'>Voltar ao início do protótipo</button> </Link>
          </div>
          </>
        )}
        </div>
